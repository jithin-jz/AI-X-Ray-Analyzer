...
from domains.scan.service import get_scan, save_ai_result
...
async def analyze_scan(
    ...
    try:
        ...
        # from domains.ai.preprocessing import preprocess_image
        # from domains.ai.inference import run_inference
        # from domains.ai.gradcam import generate_gradcam
