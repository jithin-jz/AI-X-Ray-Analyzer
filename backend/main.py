...
from api.v1.passkey.router import router as passkey_router
from api.v1.tenant.router import router as tenant_router
from api.v1.user.router import router as user_router
from api.v1.patient.router import router as patient_router
from api.v1.scan.router import router as scan_router
