...
from api.v1.scan.service import get_scan, save_ai_result
...
async def analyze_scan(
    ...
    try:
        ...
        # from api.v1.ai.preprocessing import preprocess_image
        # from api.v1.ai.inference import run_inference
        # from api.v1.ai.gradcam import generate_gradcam
