...
from routes.scan.logic import get_scan, save_ai_result
...
async def analyze_scan(
    ...
    try:
        ...
        # from routes.xray_analysis.preprocessing import preprocess_image
        # from routes.xray_analysis.inference import run_inference
        # from routes.xray_analysis.gradcam import generate_gradcam
